  ...
  return (
    <main>
          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center justify-center flex-col">
                <Button size="lg" className="p-8 mb-8 md:mb-0 text-2xl w-full sm:w-fit border-t-2 rounded-full border-[#4d4d4d] bg-[#1f1f1f] hover:bg-white group transition-all flex items-center justify-center gap-4 hover:sahdow-xl hover:shadow-neutral-500 duration-500">
      ...
      <section className="mt-[-500px]">
        <LampComponent />
        <div className="flex flex-wrap itesm-center justify-center flex-col md:flex-row gap-8 -mt-72 mb-8">
